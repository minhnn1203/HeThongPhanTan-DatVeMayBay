...
-- Migration: add TELEGRAM_CHAT_ID column if missing (for existing tables)
BEGIN
   EXECUTE IMMEDIATE 'ALTER TABLE USER_APP.USERS ADD (TELEGRAM_CHAT_ID VARCHAR2(50))';
EXCEPTION WHEN OTHERS THEN
   IF SQLCODE != -1430 AND SQLCODE != -01430 THEN
      RAISE;
   END IF;
END;
/
